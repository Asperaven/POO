...
public class AgendamentoDAO {
    ...
    public void cadastrarAgendamento(Agendamento agendamento) {
        String sql =
            "INSERT INTO agendamentos (medico, paciente, data) VALUES (?, ?, ?)";
    ...
    public ArrayList<Agendamento> buscarAgendamentos(
    ...
    public void removerAgendamento(Agendamento agendamento) {
        String sql =
            "DELETE FROM agendamentos WHERE medico = ? AND paciente = ? AND data = ?";
        try (
            Connection conexao = DBConnection.getConnection();
            PreparedStatement statement = conexao.prepareStatement(sql);
        ) {
