...
public class ConsultaDAO {
    ...
    public void cadastrarConsulta(Consulta consulta) {
        String sql =
            "INSERT INTO consultas (medico, paciente, data, descricao, receita, exames, valor) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        try (
            ...
            throw new RuntimeException(
                "Erro ao salvar consulta: " + e.getMessage()
            );
        }
    }
        ...
        try (
            ...
            while (rs.next()) {
                ...
                if (pacienteEncontrado != null) {
                    pacienteEncontrado.adicionarConsultaHistorico(consulta);
                }
            }
        } catch (SQLException e) {
