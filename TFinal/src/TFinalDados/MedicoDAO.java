...
public class MedicoDAO {
    public void cadastrarMedico(Medico medico){
        String sql = "INSERT INTO medicos (nome, especialidade, valorConsulta, senha, tipo) VALUES (?, ?, ?, ?, ?)";
        ...
        try(Connection conexao = DBConnection.getConnection();
            ...
            if(medico instanceof MedicoCardiologista)
                statement.setString(5, "Cardiologista");
            else if(medico instanceof MedicoDermatologista)
                statement.setString(5, "Dermatologista");
            else
                statement.setString(5, "Pediatra");
        ...
        try(Connection conexao = DBConnection.getConnection();
            ...
            while(resultset.next()){
                ...
                if(tipo.equals("Cardiologista")){
                    //nome, valor, senha
                    medico = new MedicoCardiologista(resultset.getString("nome"),
                            resultset.getDouble("valor"), resultset.getString("senha"));
                } else if(tipo.equals("Dermatologista")){
                    medico = new MedicoDermatologista(resultset.getString("nome"),
                            resultset.getDouble("valor"), resultset.getString("senha"));
                } else {
                    medico = new MedicoPediatra(resultset.getString("nome"),
                            resultset.getDouble("valor"), resultset.getString("senha"));
                }
