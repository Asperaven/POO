...
public class AgendamentoPanel extends JPanel {
    ...
    private void criarInterface() {
        JPanel header = PesquisaMedicoPanel.criarHeaderComVoltar("📅 Agendamentos", mainFrame);
        ...
        JButton botaoAgendar = MainFrame.criarBotao("Agendar", MainFrame.COR_SUCESSO);
        ...
        JButton botaoCancelar = MainFrame.criarBotao("❌ Cancelar Agendamento", MainFrame.COR_ERRO);
    ...
    public void setMedicoSelecionado(Medico medico) {
        ...
        if (medico != null) {
            labelMedico.setText(medico.toString() + " — R$ " + String.format("%.2f", medico.getValorConsulta()));
        }
    }
    ...
    public void atualizar() {
        ...
        if (usuario instanceof Paciente) {
            listaAgendamentos = mainFrame.getSistema().getAgendamentosPaciente((Paciente) usuario);
        } else if (usuario instanceof Medico) {
            listaAgendamentos = mainFrame.getSistema().getAgendamentosMedico((Medico) usuario);
        }
    ...
    private void realizarAgendamento() {
        ...
        try {
            mainFrame.getSistema().agendarConsulta(medicoSelecionado, paciente, data);
            JOptionPane.showMessageDialog(this,
            ...
            int opcao = JOptionPane.showConfirmDialog(this,
                    ...
                    "Agenda Lotada", JOptionPane.YES_NO_OPTION);
            if (opcao == JOptionPane.YES_OPTION) {
                mainFrame.getSistema().entrarListaEspera(medicoSelecionado, paciente, data);
                JOptionPane.showMessageDialog(this,
