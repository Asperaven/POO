...
public class EstatisticasPanel extends JPanel {
    ...
    public void atualizar() {
        ...
        String nomeMelhor =
            melhor != null && melhor.getMediaEstrelas() > 0
                ? melhor.getNome()
                : "N/A";
        String notaMelhor =
            melhor != null && melhor.getMediaEstrelas() > 0
        ...
        JLabel tituloGrafico = MainFrame.criarLabel(
            "📊 Consultas por Médico",
            16,
            true
        );
        ...
        Map<String, Integer> consultasPorMedico =
            sistema.getConsultasPorMedico();
        int maxConsultas = consultasPorMedico
            .values()
            .stream()
            .mapToInt(Integer::intValue)
            .max()
            .orElse(1);
        if (maxConsultas == 0) maxConsultas = 1;
        ...
        for (Map.Entry<String, Integer> entry : consultasPorMedico.entrySet()) {
            ...
            JPanel barra = new JPanel() {
                ...
                protected void paintComponent(Graphics g) {
                    ...
                    int largura = (int) (((double) valor / maxVal) *
                        (getWidth() - 60));
                    if (largura < 4) largura = 4;
    ...
    private JPanel criarCardEstatistica(
        String emoji,
        String titulo,
        String valor,
        String subtitulo,
