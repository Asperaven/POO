...
public class MainAutomatico {
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (vencedor == null && (!robo1.isEliminado() || !robo2.isEliminado())) {
            ...
            if (rodada % 2 == 1) {
                // Vez do Robo 1 (Regular - usa int)
                System.out.println("RODADA " + String.format("%2d", rodada) + " - Vez do Robo 1 (" + robo1.getCor() + ")...");
                
                if (!robo1.isEliminado()) {
                    int direcao1 = random.nextInt(4) + 1; // 1-4
                    int[] tentativa1 = robo1.calcularProxima(direcao1);
                    try {
                        ...
                        System.out.println(RED + "✗ Robo " + robo1.getCor() + " tentou se mover para " + direcoes[direcao1] + " - INVALIDO" + RESET);
                    }
                } else {
